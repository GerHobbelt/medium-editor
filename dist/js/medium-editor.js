...
(function () {
    ...
    var AnchorDocumentForm = MediumEditor.extensions.form.extend({
        /* Anchor Form Options */
    ...
    MediumEditor.extensions.anchorDocument = AnchorDocumentForm;
}());
(function () {
    'use strict';

    var AnchorCalendarForm = MediumEditor.extensions.form.extend({

        // Options for the Button base class
        name: 'anchorCalendar',
        action: 'createLink',
        aria: 'Lien vers l\'application Agenda',
        tagNames: ['a'],
        contentDefault: '<b>Doc</b>',
        contentFA: '<i class="fa fa-calendar"></i>',
    ...
    MediumEditor.extensions.anchorCalendar = AnchorCalendarForm;
}());
(function () {
    'use strict';
